...
extern int sin_table[FIXED_TRIG_SIZE];   // this should be filled in by external module
...
// Switched it back to unsigned char for compatibility. Prob. still broken.
...
{
    /* Factories */
    static LChar *Create(unsigned short ch);
...
{
    /* Factories */
    static LFixedPoint *Create(int x);
