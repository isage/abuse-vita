...
char const *ability_names[TOTAL_ABILITIES]
    = {"start_hp",      "start_accel",    "stop_accel", "jump_xvel",   "jump_yvel",
       "run_top_speed", "jump_top_speed", "tint_color", "push_xrange", "walk_top_speed"};

long abil_def[TOTAL_ABILITIES] = {6, 3, 4, 2, -16, 10, 6, 0,
