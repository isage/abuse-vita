...
{
  int tleft, ttop, tright, tbottom, text_y, text_step, pan_xv, pan_yv, pan_steps, frame_speed, scroll_speed, pan_speed,
      scene_abort;
  char *text;
...
public:
  ...
  void set_frame_speed(int speed)
  {
    frame_speed = speed;
  }
  ...
  void set_pan_speed(int speed)
  {
    pan_speed = speed;
  }
  void set_pan(int xv, int yv, int steps)
  {
    pan_xv    = xv;
    pan_yv    = yv;
    pan_steps = steps;
