...
(select section
	('game_section
	 ...
	 (setq space_cont "Press Start to continue")        ; V-E
	 ...
	 (defun get_train_msg (message_num)
	   (select message_num
		   ...
		   (0 "Aim with right stick, fire with right trigger")
		   ...
		   (5 "Hold down left trigger to use special powers")
		   (6 "Use the SQUARE & TRIANGLE keys to select weapons")
